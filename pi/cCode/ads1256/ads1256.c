...
/* Custom functions by tom: */
int ads1256_init(void);
void ads1256_read(uint8_t ch_num, int32_t *adc);
int ads1256_end(void);
...
int ads1256_read2(uint8_t ch_num) {
