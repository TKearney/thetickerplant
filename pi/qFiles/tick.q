...
"Chained TP on raspberry pi starting..."
/q tick.q SRC [DST] [-p 5010] [-o h]
/system"l tick/",(src:first .z.x,enlist"schemas"),".q"
src:first .z.x;
/\l ../../server/kdbFiles/kdb-tick-master/tick/schemas.q
...
if[not system"t";system"t 1000";
 .z.ts:{ts .z.D};
//.u.upd:{y[0]:.z.n;x insert y}
 upd:{[t;x]x[0]:.z.n;ts"d"$a:.z.P;
 if[not -16=type first first x;a:"n"$a;x:$[0>type first x;a,x;(enlist(count first x)#a),x]];
	pub[t;x];if[l;l enlist (`.u.upd;t;x);i+:1];}];
/upd:insert;
...
.u.rep .(h)"(.u.schemas[`;`];`.u `i`L)";
/.u.rep .(h)"(.u.sub[`;`])";

/subscribe to all tables.
neg[h]({neg[.z.w]"(.u.sub[`;`])"};());
/neg[h]({neg[.z.w]"(.u.sub[`;`];`.u `i`L)"};());
/neg[h]({neg[.z.w]"{x[0] set x[1]}each tables[];
