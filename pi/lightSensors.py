...
def publishToTp():
	...
	q.lux=K.short(readVisibleLux())
	q.visIR=K.short(channel0)
	q.IR=K.short(channel1)
	...
	q.airTemp=airTemp
	print "Sending to TP"
	q('h(`.u.upd;`metrics;(.z.n;`chili1;lux;visIR;IR;0Nf;humidity;airTemp;0Nf;0Nf;0Nf;0Nh;0nf))')
	print "Sent to TP"
